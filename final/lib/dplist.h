...
/*
 * interpretation of my DPLIST code was derived from the book "understanding and Using C pointers" by Richard Reese, chapter 6 "Pointers and Structures" 
 */ 
...
// Returns a reference to the first list node in the list containing 'reference'. 
// If the list is empty, NULL is returned. 
// If 'reference' is not found in the list, NULL is returned.
